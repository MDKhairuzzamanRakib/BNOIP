...
(function () {
    ...
    angular.module("app").constant("dataConstants", {
        ...
        FEED_BACK_URL: baseAPIUrl + 'api/bnois/feed-back/',
        DOWNLOAD_URL: baseAPIUrl + 'api/bnois/download/',
        BULK_USER_URL: baseAPIUrl + 'api/bnois/bulk-user/',
        FLASH_NOTICE_URL: baseAPIUrl + 'api/bnois/flash-notice/',
    });
})();