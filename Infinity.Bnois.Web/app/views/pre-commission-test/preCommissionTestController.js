...
(function () {
    ...
    var controllerId = 'preCommissionTestController';

    angular.module('app').controller(controllerId, preCommissionTestController);
    preCommissionTestController.$inject = ['$stateParams','employeeService','currentStatusService', 'notificationService','codeValue', '$state'];

    function preCommissionTestController($stateParams, employeeService, currentStatusService, notificationService, codeValue, $state) {
        var vm = this;
        vm.pNo = 0;
        vm.preCommissionTest = {};
