(function () {
    'use strict';
    angular.module('app').service('feedbackFormService', ['dataConstants', 'apiHttpService', feedbackFormService]);

    function feedbackFormService(dataConstants, apiHttpService) {
        var service = {
            //getColors: getColors,
            //getColor: getColor,
            //saveColor: saveColor,
