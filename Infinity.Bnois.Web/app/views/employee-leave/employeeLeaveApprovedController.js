(function () {
    ...
    'use strict';
    var controllerId = 'employeeLeaveApprovedController';
    angular.module('app').controller(controllerId, employeeLeaveApprovedController);
    employeeLeaveApprovedController.$inject = ['$state', 'employeeLeaveService', 'notificationService', '$location'];

    function employeeLeaveApprovedController($state, employeeLeaveService, notificationService, location) {
        ...
        function init() {
            ...
            employeeLeaveService.GetEmployeeApprovedLeavesForAuthorizedUser(vm.pageSize, vm.pageNumber, vm.searchText, vm.leaveTypeId).then(function (data) {
