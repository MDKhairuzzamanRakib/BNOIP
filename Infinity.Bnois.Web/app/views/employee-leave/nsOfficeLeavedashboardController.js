(function () {
    ...
    'use strict';
    var controllerId = 'nsOfficeLeavedashboardController';
    angular.module('app').controller(controllerId, nsOfficeLeavedashboardController);
    nsOfficeLeavedashboardController.$inject = ['$state', 'employeeLeaveService', 'notificationService', '$location'];

    function nsOfficeLeavedashboardController($state, employeeLeaveService, notificationService, location) {
